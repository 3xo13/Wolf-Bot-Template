...
class Cache {
  constructor () {
    ...
    this.lock = promisify(redisLock(this.client));
  ...
  async getGameById (id) {
    return await this._get(`game.id:${id}`);
  }
  ...
  async setGameById (id, value) {
    return await this._set(`game.id:${id}`, JSON.stringify(value), TIME_ONE_WEEK);
  }
  ...
  async deleteGameById (id) {
    return await this._delete(`game.id:${id}`);
  }
